...
// $update = "INSERT INTO `plans` VALUES (NULL,'$plan_name' , '$plan_price' , '$plan_range');
$update = "INSERT INTO `plans` VALUES (NULL,'$plan_name' , '$plan_price' , '$plan_range')";
                                 ...
                                 <form action="" class="form" method="POST">
                                    ...
                                    <div class="form-sec">
                                        <label for="">Plan Name </label>
                                          ...
                                          <input name="plan_name"  placeholder="plan name" value="" id=""></input> <br><br>
                                    </div>
                                    ...
                                    <div class="form-sec">
                                     ...
                                     <input name="plan_price"  placeholder="plan price"value="" id="">
                                    </div>
                                    ...
                                    <div class="form-sec">
                                        <label for="">Plan Range</label>
                                          ...
                                          <input name="plan_range" value="" id=""placeholder="plan range">
                                    </div>
