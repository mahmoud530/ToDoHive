...
<body>
    ...
    <section class="home">
        ...
        <div class="add-btns">
            <?php if ($role_id == 2) { ?>
                <a href="subscription.php" class="add-btn">Upgrade <span><i class='bx bx-plus icon'
                            style="font-size: 20px;"></i></span></a>
                <a href="add_project.php" class="add-btn">Add Project <span><i class='bx bx-plus icon'
                            style="font-size: 20px;"></i></span></a>
                <!-- <a href="" class="add-btn">Add Project <span>
            <i class='bx bx-plus icon' style="font-size: 20px;"></i> -->
            <?php } else { ?>
                <!-- </span> </a> -->
                <a href="subscription.php" class="add-btn1">Subscribe <span><i class='bx bx-plus icon'
                            style="font-size: 20px;"></i></span></a>
            <?php } ?>
        </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="hehe">
                                            ...
                                            <a class="del" href="dashboard2.php?delete=<?php echo $data['project_id'] ?>">
                                                ...
                                                if ($number_leader > 0) { ?>
                                                    <a class="del" href="dashboard2.php?delete=<?php echo $data['project_id'] ?>"><i
                                                            class="fa-solid fa-trash" style="color:black; font-size:12px"></i></a>
                                                <?php } ?>
                                        ...
                                        <p class="title"><a
                                                href="project_details.php?project_id=<?php echo $data['project_id'] ?>">View
                                                Project</a></p>
                                    </div>
                                </div>
                            </div>
